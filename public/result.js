  ...
  const personalityAnalyzer = (() => {
    const SCORING_RULES = {
      explorer_vs_guardian: [
        ...
        { qId: "q16_new_word", weight: 2.5, scores: { "一种难以言说的美好感觉": 1, "一种微妙的社交尴尬": 0.5, "一种对未来的乐观期待": 1.5, "一种独处时的舒适感": -0.5 } },
        ...
        { qId: "q90_last_day_on_earth", weight: 1.5, scores: { "去做一件一直想做却没敢做的事": 1, 和最爱的人待在一起: 0, 吃遍所有想吃的美食: 0.5 } },
      ],
      extrovert_vs_introvert: [
        { qId: "q31_social_battery", weight: 2.5, dynamicScore: (val) => (parseInt(val, 10) - 50) / 25 },
        ...
        { qId: "q49_unplug_way", weight: 1.2, scores: { 和朋友面对面聊天: 1, 去户外散步或运动: 0.5, 看一本纸质书: -0.5 } },
      ...
      feeling_vs_thinking: [
        ...
        { qId: "q27_ideal_world", weight: 1.5, scores: { 绝对的公平: 1, 绝对的自由: -0.5 } },
        { qId: "q58_joy_source", weight: 1, scores: { 与人分享带来的快乐: 1, 获得成就带来的喜悦: -1 } },
        { qId: "q81_accepting_criticism", weight: 1.2, scores: { 感到沮丧和自我怀疑: 1, 本能地想要辩护: -0.5, 反思其中有价值的部分: -1 } },
      ],
    };

    const KEYWORD_RULES = {
      extrovert_vs_introvert: {
        q14_spirit_animal: { 狮: 1, 狗: 1, 海豚: 1, 狼: 0.5, 燕子: 0.5, 猫: -1, 狐狸: -0.5, 鲸: -1, 猫头鹰: -1 },
        q20_fictional_friend: { 社交: 1, 朋友: 1, 派对: 1, 独处: -1, 思考: -1, 安静: -1, 内向: -1, 外向: 1 },
      },
      feeling_vs_thinking: {
        q11_scent_memory: { 花: 1, 雨: 1, 阳光: 1, 海: 1, 面包: 0.5, 泥土: 0.5, 书: -0.5, 墨香: -0.5 },
        q17_dream_job: { 情绪调酒师: 1, 梦境设计师: 1, 星际植物学家: -0.5, 时光旅行导游: 0.5 },
